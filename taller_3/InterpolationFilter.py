...
def interpolation_fft(image, i_value):
    ...
    # Calculate gray scale image if necessary
    ...
    # Compute interpolated image: start by creating an empty image
